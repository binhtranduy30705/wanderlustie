...
export default class Curation {
    ...
    handlePayload(payload) {
        ...
        switch (payload) {
            case "SUMMER_COUPON":
                response = [
                    BotResponse.genText(i18n.__("leadgen.promo", {
                        userFirstName: this.user.firstName,
                    })),
                    BotResponse.genGenericTemplate(`${config.appUrl}/coupon.png`, i18n.__("leadgen.title"), i18n.__("leadgen.subtitle"), [BotResponse.genPostbackButton(i18n.__("leadgen.apply"), "COUPON_50")]),
                ];
                break;
            case "COUPON_50":
                ...
                response = [
                    ...
                    BotResponse.genGenericTemplate(`${config.appUrl}/looks/${outfit}.jpg`, i18n.__("curation.title"), i18n.__("curation.subtitle"), [
                        BotResponse.genWebUrlButton(i18n.__("curation.shop"), `${config.shopUrl}/products/${outfit}`),
                        BotResponse.genPostbackButton(i18n.__("curation.show"), "CURATION_OTHER_STYLE"),
            ...
            case "CURATION_OTHER_STYLE":
                outfit = `${this.user.gender}-${this.randomOutfit()}`;
                response = BotResponse.genGenericTemplate(`${config.appUrl}/looks/${outfit}.jpg`, i18n.__("curation.title"), i18n.__("curation.subtitle"), [
                    BotResponse.genWebUrlButton(i18n.__("curation.shop"), `${config.shopUrl}/products/${outfit}`),
                    BotResponse.genPostbackButton(i18n.__("curation.show"), "CURATION_OTHER_STYLE"),
                ]);
                break;
            case "PRODUCT_LAUNCH":
                outfit = `${this.user.gender}-${this.randomOutfit()}`;
                response = BotResponse.genRecurringNotificationsTemplate(`${config.appUrl}/looks/${outfit}.jpg`, i18n.__("curation.productLaunchTitle"), "WEEKLY", "12345");
                break;
            default:
    ...
    genCurationResponse(payload) {
        ...
        if (budget === "50") {
            buttons.push(BotResponse.genPostbackButton(i18n.__("curation.sales"), "CARE_SALES"));
        }
        return BotResponse.genGenericTemplate(`${config.appUrl}/looks/${outfit}.jpg`, i18n.__("curation.title"), i18n.__("curation.subtitle"), buttons);
    }
    randomOutfit() {
